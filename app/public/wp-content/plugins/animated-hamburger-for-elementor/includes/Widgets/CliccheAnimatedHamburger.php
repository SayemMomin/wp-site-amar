...
class CliccheAnimatedHamburger extends Widget_Base {
	...
	$this->add_control(
			...
			[
				...
				'options' => [
					...
					'emphatic' => __( 'Emphatic', 'clicche-elementor' ),
					'emphatic-r' => __( 'Emphatic Reverse', 'clicche-elementor' ),
  ...
  protected function render() {
		...
		?>
		<a title='<?= $title ?>' <?= $href  ?>>
			<div class='clicche-hamburger-block' data-target-type='<?= $target ?>' data-target='<?= $settings['popup'] ?>' id='clicche-hamburger-<?= $this->get_id() ?>'>
